...
int main(int argc, char *argv[])
{
    ...
    */
    ...
    /*
        Load some sounds
    */
    result = FMOD_System_CreateSound(system, "../fmod/media/drumloop.wav", FMOD_SOFTWARE | FMOD_3D, 0, &sound1);
    ERRCHECK(result);
    ...
    result = FMOD_System_CreateSound(system, "../fmod/media/jaguar.wav", FMOD_SOFTWARE | FMOD_3D, 0, &sound2);
    ERRCHECK(result);
    ...
    result = FMOD_System_CreateSound(system, "../fmod/media/swish.wav", FMOD_SOFTWARE | FMOD_2D, 0, &sound3);
    ERRCHECK(result);
